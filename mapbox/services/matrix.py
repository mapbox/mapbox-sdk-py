...
class DirectionsMatrix(Service):
    ...
    valid_profiles = [
        "mapbox/driving", "mapbox/cycling", "mapbox/walking", "mapbox/driving-traffic"
    ]
    ...
    def _validate_profile(self, profile):
        ...
        if profile in profiles_map:
            ...
            warnings.warn(
                "Converting deprecated profile, use {} instead".format(profile),
    ...
    def matrix(
        self, coordinates, profile="mapbox/driving", sources=None, destinations=None
    ):
